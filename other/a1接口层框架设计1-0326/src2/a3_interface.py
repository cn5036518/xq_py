...
#3 定义接口类
class Interface_test:
    # def __init__(self,url,params1,headers,check_point1,method1,data_type1,yes_no1,i):
    def __init__(self,url,params1,headers,check_point1,method1,data_type1,yes_no1):
        ...
        # self.i = i  #这里的i是excel的行数，在遍历case类中，传递过来的，在写入excel的测试结果和和响应数据的时候用到
    ...
    #二，前面先做分支判断，得到响应数据
        ...
        if result2 == self.check_point1["error_code"] :   #
            ...
            path1 = r"D:\PycharmProjects\xiaoqiang\base_181027\a1接口层框架设计1-0326\src2\testcase2.xlsx"
            ...
            # sh1.cell(row=self.i, column=12).value = result1  #excel写入的必须是json字符串

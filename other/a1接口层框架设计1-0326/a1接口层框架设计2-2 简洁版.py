...
class Interface_test:
    def __init__(self,url,param1,headers,check_point1,method1,data_type):
        self.url = url
        self.params1 = params1
...
#新建对象
test1 = Interface_test(url,params1,headers1,check_point1,method1,data_type)  #自动执行构造方法，传入参数

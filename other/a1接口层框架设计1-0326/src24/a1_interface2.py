...
#一、读取excel
#1指定excel的路径
path1 = r"D:\PycharmProjects\xiaoqiang\base_181027\a1接口层框架设计1-0326\src24\testcase2.xlsx"
...
#二、接口类
class Interface1:
    def test(self,url,params1,headers1,method1,data_type1,check_point1,yes_no1,i):
...
class For_case1:
    def for_case1(self):
        for i in range(max_row1-1):  #0,1
            ...
            url1 = sh1.cell(i+2,3).value   #python3.3.3版本不支持（田电脑） python3.3.5版本才支持(我家里电脑)
            ...
            i1 = Interface1()
            i1.test(url, params1, headers1, method1, data_type1, check_point1, yes_no1, i+2)

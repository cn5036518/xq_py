...
class Interface_test:
    ...
    def __init__(self,url,params1,headers,check_point1,method1,data_type1):
        self.url = url
        self.params1 = params1
...
# path1 = r"D:\PycharmProjects\xiaoqiang\base_181027\a1接口层框架设计1-0326\testcase2.xlsx"
    def forcase(self):
        path1 = r"D:\PycharmProjects\xiaoqiang\base_181027\a1接口层框架设计1-0326\src\testcase2.xlsx"
        ...
        for i in range(max_row1-1):  # 获取每一行的数据
            ...
            headers1 = {}
            return (url,method1,data_type1,params1,check_point1,headers1)
...
# 三、新建对象
# test1 = Interface_test(url, params1, headers1, check_point1, method1, data_type1,yes_no1)  # 自动执行构造方法，传入参数
test1 = Interface_test(*ret1)  # 自动执行构造方法，传入参数
# # 对象调方法
test1.test()

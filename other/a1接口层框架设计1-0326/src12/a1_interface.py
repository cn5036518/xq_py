...
#全局变量
path1 = r"D:\PycharmProjects\xiaoqiang\base_181027\a1接口层框架设计1-0326\src12\testcase2.xlsx"
...
#2 定义接口类
class Interface_test:
    def __init__(self,url,param1,headers,check_point1,method1,data_type1,yes_no1,row):
        self.url = url
        self.params1 = params1
    ...
    #二，前面先做分支判断，得到响应数据，这里统一进行正则匹配
        ...
        # path1 = r"D:\PycharmProjects\xiaoqiang\base_181027\a1接口层框架设计1-0326\src6\testcase2.xlsx"

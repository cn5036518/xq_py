...
# 3读取excel
path1 = r"D:\xq_py\08接口自动化框架\testcase.xlsx"
...
#2接口类
class Interface2:
    def __init__(self,url,headers1,params1,method1,data_type1,yes_no1,check_point1,i):
        self.url = url
    ...
    #     self.url = args[0]
    #     self.headers1 = args[1]
    #     self.params1 = args[2]
    #     self.method1 = args[3]
    #     self.data_type1 = args[4]
    #     self.yes_no1 = args[5]
    #     self.check_point1 = args[6]
    ...
    def test(self):
        ...
        if ret1 == ret2:
            ...
            print(self.i)
            sh1.cell(row=self.i, column=12).value = result1
            wb1.save(path1)
            # print("测试通过2")
        else:
            print("测试不通过")
...
class For_case:
    def for_case(self):
        ...
        for i in range(max_row1-1):
            ...
            # li1.append(i+2)
            # li2.append((url,headers1,params1,method1,data_type1,yes_no1,check_point1,i+2))
        ...
        #     print(li2)
        # return (li1,li2)
            Interface2(url,headers1,params1,method1,data_type1,yes_no1,check_point1,i+2).test()
        # print(li2)

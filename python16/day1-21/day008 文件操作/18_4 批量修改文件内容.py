...
import os
import time
path1 = r".\002\alex6.txt"
path2 = r".\002\alex7.txt"
...
# time.sleep(5) # 慢动作回放，在路径下"D:\xq_py\全栈16\day008 文件操作\002"看到
# 删除文件1，将文件2重命名为文件1的过程
os.remove(path1)  #删除文件，参数是文件的路径
# time.sleep(5)
os.rename(path2,path1)  #重命名文件,将参数1重命名为参数2
